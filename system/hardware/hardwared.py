...
THERMAL_BANDS = OrderedDict({
  ThermalStatus.green: ThermalBand(None, 130.0),
  ThermalStatus.yellow: ThermalBand(130.0, 130.0),
  ThermalStatus.red: ThermalBand(130.0, 130.0),
  ThermalStatus.danger: ThermalBand(130.0, None),
})

# Override to highest thermal band when offroad and above this temp
OFFROAD_DANGER_TEMP = 130
